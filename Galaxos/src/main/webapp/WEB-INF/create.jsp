...
<div class="container text-secondary mt-5">
  <div class="row">
    <div class="col-7">
<img class="border border-secondary border-3" src="images/g4.jpg" height="800" width="" alt="...">
    </div>
    <div class="col-5">
      <h1 class="text-center">Make your own ${loggedUser.userName}.</h1>
      <!-- Color picker -->
      <form:form action="/create/wallpaper" method="post" modelAttribute="wallpaper">
