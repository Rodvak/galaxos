        ...
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center border border-secondary border-3">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <p class="text-white-50 mt-5">Please enter your login and password</p>
            ...
            <div>
              <p class="mb-0">Don't have an account? <a href="/register" class="text-secondary fw-bold">Sign Up</a>
              </p>
            </div>
          </div>
        </div>
