...
<div class="container text-secondary mt-5">
  <div class="row">
    <div class="col-7">
	<img class="border border-secondary border-3" src="images/g5.jpg" height="800" width="" alt="...">
    </div>
    <div class="col-5">
      <h1 class="text-center">Pink Sky</h1>
  ...
  <option value="1">10</option>
      ...
      <h1 class="text-center mt-5">Price per roll: $500.00 </h1>
       ...
       <div class="d-flex justify-content-center mt-5">
 			<a class="btn btn-outline-secondary me-5" href="/buy5">Buy</a> <a class="btn btn-outline-secondary ms-5" href="/gallery">Back</a>
		</div>
    </div>
    </div>
  </div>
